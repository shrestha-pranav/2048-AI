...
for g in range(65536):
    ...
    empty_tiles[g] = [i for i in range(4) if row[i]==0]
...
def move_grid(g, move):
    ...
    r = get_rows(g)
    if move == 3:
        return map_right[r[0]]<<48 | map_right[r[1]]<<32 | map_right[r[2]]<<16 | map_right[r[3]]
    return map_left[r[0]]<<48 | map_left[r[1]]<<32 | map_left[r[2]]<<16 | map_left[r[3]]